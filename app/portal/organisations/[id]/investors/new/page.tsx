...
export default async function NewInvestorPage({
  ...
  const { data: interestExpenseAccounts } = await supabase
    ...
    .eq("organisation_id", id)
    .eq("is_active", true)
    .in("account_type", ["FINANCE_COST", "OPERATING_EXPENSE"])
    .order("account_code", { ascending: true });
          ...
          <div className="mt-8 flex items-start gap-5">
            ...
            <div>
              ...
              <p className="mt-4 max-w-3xl text-base leading-8 text-slate-600">
                Add an investor, lender, shareholder, director, grant funder, or
                other funding provider for {organisationName}. This supports
                capital tracking, debt schedules, ownership analysis, interest
                monitoring, investor-grade reporting, and financing activities.
              </p>
            </div>
          </div>
        </div>
